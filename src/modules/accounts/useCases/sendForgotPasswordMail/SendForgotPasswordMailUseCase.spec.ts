...
describe("Send Forgot Mail", () => {
    ...
    it("should be able to send a forgot password mail tom user", async () => {
    ...
    it("should not be able to send an email if user does not exists", async () => {
        await expect(
            sendForgotPasswordMailUseCase.execute("fihulotez@ejo.ve")
    ...
    it("should be able to create an users token", async () => {
        ...
        await usersRepositoryInMemory.create({
            driver_license: "344432",
            email: "ju@jejalpic.pn",
            name: "Maggie Swanson",
            password: "9803",
        });

        await sendForgotPasswordMailUseCase.execute("ju@jejalpic.pn");
